...
namespace Unicom_TIC.Views.StaffView
{
    public partial class Staff_Marks : UserControl
    {
        ...
        private void TimetableSave_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(MarksScore.Text, NumberStyles.Number, CultureInfo.InvariantCulture, out score))
            {
            ...
            {
                MessageBox.Show("Score must be between 0 and 100.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            studentId = Convert.ToInt32(MarksStudentID.Text);
